...
`NOMINAL_BASE_URL` is optional and defaults to `https://api.gov.nominal.io/api`. `NOMINAL_WORKSPACE_RID` is optional: when set, the health check verifies access to that workspace.

...
5. Recommended: set **Workspace RID** (Nominal app: **Settings > API keys > Copy RID**) to limit the assets you can browse to one workspace. Empty browses every workspace the key can access.
6. Select **Save & test**.
